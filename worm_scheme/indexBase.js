var _parent = wormHelper.refreshModule("./worm_scheme/renderBase.js");
var _proto = indexBase.prototype = Object.create(_parent);
...
_proto.render = function() {
	...
	if (siteProp.isPartialLoad) {
		...
		if ("pageViewerName" in siteMap) {
				if (siteMap.pageViewerName in pageObject) {
